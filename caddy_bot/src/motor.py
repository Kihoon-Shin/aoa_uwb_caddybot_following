...
def callback(msg):
    ...
    if(WHEEL_VELOCITY_CMD[LEFT] > 50):
        WHEEL_VELOCITY_CMD[LEFT] = 50
    elif(WHEEL_VELOCITY_CMD[LEFT] < -50):
        WHEEL_VELOCITY_CMD[LEFT] = -50
    if(WHEEL_VELOCITY_CMD[RIGHT] > 50):
        WHEEL_VELOCITY_CMD[RIGHT] = 50
    elif(WHEEL_VELOCITY_CMD[RIGHT] < -50):
        WHEEL_VELOCITY_CMD[RIGHT] = -50
